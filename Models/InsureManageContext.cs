...
{
    public partial class InsureManageContext : DbContext
    {
        public InsureManageContext()
        {
        }

        public InsureManageContext(DbContextOptions<InsureManageContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.NoteProduct)
                    .IsUnicode(false)
                    .HasColumnName("Note_Product");

                entity.Property(e => e.PositionProduct).HasColumnName("Position_Product");
            });
